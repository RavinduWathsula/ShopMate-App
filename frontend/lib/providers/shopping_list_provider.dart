  ...
  ShoppingListNotifier()
    : super([
        ...
        const ShoppingListItem(
          ...
          imageUrl:
              'https://images.unsplash.com/photo-1626806819282-2c1dc01a5e0c?w=200',
        ),
        const ShoppingListItem(
          id: '9',
          name: 'Coca Cola 1.5L',
        ...
        const ShoppingListItem(
          ...
          imageUrl:
              'https://images.unsplash.com/photo-1612929633738-8fe01f746694?w=200',
        ),
        const ShoppingListItem(
          id: '17',
          ...
          icon: Icons.cleaning_services_rounded,
          imageUrl:
              'https://images.unsplash.com/photo-1559596395-9b244766bc70?w=200',
        ),
        const ShoppingListItem(
          id: '18',
          ...
          imageUrl:
              'https://images.unsplash.com/photo-1600857062241-98e5dba7f214?w=200',
        ),
        const ShoppingListItem(
          id: '19',
          ...
          icon: Icons.local_drink_rounded,
          imageUrl:
              'https://images.unsplash.com/photo-1582236592209-a1b7e61ff0eb?w=200',
        ),
        const ShoppingListItem(
          id: '20',
          ...
          imageUrl:
              'https://images.unsplash.com/photo-1579899201099-dafb3cc961ff?w=200',
        ),
      ]);
